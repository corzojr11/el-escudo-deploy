import { getShifts, getCurrentStatus, getShiftConflicts } from "@/app/actions/turnos";
...
export default async function TurnosPage() {
  const [s, cs, b, planResult, confs] = await Promise.allSettled([
    getShifts(),
    getCurrentStatus(),
    getBioSettings(),
    getPlanDiario(),
